...
function App() {
  ...
  return (
    <Router>
      <div className={`min-h-screen bg-gray-50 ${i18n.language === 'ar' ? 'font-arabic' : 'font-latin'}`}>
        <Navbar />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold mb-4">WorkersHub</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/workers" className="text-gray-300 hover:text-white">{t('nav.workers')}</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><span className="text-gray-300">{t('professions.housemaid')}</span></li>
              <li><span className="text-gray-300">{t('professions.cleaner')}</span></li>
              <li><span className="text-gray-300">{t('professions.cook')}</span></li>
              <li><span className="text-gray-300">{t('professions.nanny')}</span></li>
            </ul>
          </div>
        </div>
